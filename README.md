...
If you need to run the "Conversion" command, you need to run "pkg install ffmpeg imagemagick sox bc -y" before that

如果你需要运行“Conversion”命令，在此之前你需要运行“pkg install ffmpeg imagemagick sox bc -y”
